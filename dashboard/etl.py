...
from dashboard.project_db import add_column_to_table, audit, SYSTEM_COLUMN_DEFS, get_current_revision
from engines.sheet_v1.backend.service import get_engine, get_columns
from dashboard.etl_compiler import (
    compile_sql,
    EtlValidationError,
    EtlCompilationError,
    expr_to_sql,
...
def etl_run_saved(
    ...
    from dashboard.staleness import mark_dependents_stale
