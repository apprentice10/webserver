...
| 17–24 | `EngineCreate` — includes `engine_version` (optional; catalog lookup fills it if omitted) |
| 27–34 | `EngineSettingsUpdate` — `current_rev` alias preserved for backward compat |
| 37–47 | `EngineResponse` — includes `engine_version` |
