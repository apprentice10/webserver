...
**Description:** Manages per-tool undo/redo stacks in server process memory. Covers cell edits, row inserts (ghost row, insert above/below, copy-insert), soft deletes, and hard deletes. Resets on server restart or page reload.
