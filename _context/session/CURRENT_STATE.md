# session/CURRENT_STATE.md

*Task index — one line per task, link to plan file. You tell me which task; I read only that plan file.*

*Unplanned items have no link. Start a /grill-me session to produce a plan file before executing.*
